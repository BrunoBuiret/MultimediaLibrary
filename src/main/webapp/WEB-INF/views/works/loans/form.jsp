...
<%@include file="/WEB-INF/views/fragments/header.jspf" %>
    ...
    <form:form cssClass="form-horizontal" method="post" action="${_url}" modelAttribute="workForm">
        ...
        <form:input
            ...
            path="idOeuvrepret"
        />
        <spring:bind path="titreOeuvrepret">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:label path="titreOeuvrepret" for="title" cssClass="control-label col-sm-2">
                    Titre*
                </form:label>
                <div class="col-sm-10">
                    <form:input
                        ...
                        path="titreOeuvrepret"
                        id="title"
                    />
                    <form:errors cssClass="help-block" path="titreOeuvrepret" />
                </div>
            </div>
        </spring:bind>
