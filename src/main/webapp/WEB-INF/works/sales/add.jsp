...
<c:set var="_page_title" value="Ajout d'une oeuvre à vendre" />
<c:set var="_page_current" value="works_sales_add" />
...
<%@include file="/WEB-INF/_inc/header.jsp" %>
    <div class="page-header">
        <h1>
            Ajout d'une nouvelle oeuvre à vendre
        </h1>
    </div>
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input
                        ...
                        <c:if test="${not empty _last_price}">
